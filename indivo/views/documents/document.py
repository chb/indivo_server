...
def __local_document_create(request, record, pha, external_id, existing_doc):
    ...
    a_principal = request.principal if request else None
    if a_principal is None:
        return HttpResponseBadRequest("The request does not contain a principal")
    ...
    try:
        ...
        return HttpResponseBadRequest("The document submitted is malformed: %s" % str(e))
