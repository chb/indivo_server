...
def document_version(request, record, document_id):
  ...
  Calls into 
  :py:meth:`~indivo_server.indivo.views.documents.document_versions._document_version`.
...
def _document_version(request, record, document_id, pha=None, external_id=None):
  ...
  * *record*: The 
    :py:class:`~indivo_server.indivo.models.records_and_documents.Record` to which
  ...
  * *pha*: The :py:class:`~indivo_server.indivo.models.apps.PHA` object used
