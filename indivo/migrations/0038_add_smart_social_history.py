...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        db.create_table('indivo_socialhistory', (
            ('fact_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['indivo.Fact'], unique=True, primary_key=True)),
            ('smoking_status_provenance_source_code', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, db_column='smoking_status_prov_sc', blank=True)),
            ('smoking_status_provenance_translation_fidelity_identifier', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, db_column='smoking_status_prov_tf_id', blank=True)),
            ('smoking_status_provenance_translation_fidelity_system', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, db_column='smoking_status_prov_tf_sys', blank=True)),
            ('smoking_status_provenance_translation_fidelity_title', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, db_column='smoking_status_prov_tf_title', blank=True)),
            ('smoking_status_provenance_title', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, db_column='smoking_status_prov_title', blank=True)),
            ('smoking_status_code_identifier', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, db_column='smoking_status_code_id', blank=True)),
            ('smoking_status_code_system', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, db_column='smoking_status_code_sys', blank=True)),
            ('smoking_status_code_title', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, db_column='smoking_status_code_title', blank=True)),
            ('smoking_status_title', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, db_column='smoking_status_title', blank=True)),
        ))
        db.send_create_signal('indivo', ['SocialHistory'])

    def backwards(self, orm):
        
        # Deleting model 'SocialHistory'
        db.delete_table('indivo_socialhistory')
