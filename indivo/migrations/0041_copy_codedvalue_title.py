...
class Migration(DataMigration):
    ...
    def forwards(self, orm):
        # SMART CodedValue title is now required, so copy over any existing titles
        # from the corresponding Code if title is empty
        
        for obj in orm.Encounter.objects.all():
            if not obj.type_title:
                obj.type_title = obj.type_code_title
            obj.save()

        for obj in orm.Immunization.objects.all():
            if not obj.product_class_title:
                obj.product_class_title = obj.product_class_code_title
            if not obj.product_class_2_title:
                obj.product_class_2_title = obj.product_class_2_code_title
            if not obj.product_name_title:
                obj.product_name_title = obj.product_name_code_title
            if not obj.administration_status_title:
                obj.administration_status_title = obj.administration_status_code_title
            if not obj.refusal_reason_title:
                obj.refusal_reason_title = obj.refusal_reason_code_title
            obj.save()

        for obj in orm.Problem.objects.all():
            if not obj.name_title:
                obj.name_title = obj.name_code_title
            obj.save()
            
        for obj in orm.VitalSigns.objects.all():
            if not obj.bp_systolic_name_title:
                obj.bp_systolic_name_title = obj.bp_systolic_name_code_title
            if not obj.bp_method_title:
                obj.bp_method_title = obj.bp_method_code_title
            if not obj.weight_name_title:
                obj.weight_name_title = obj.weight_name_code_title
            if not obj.height_name_title:
                obj.height_name_title = obj.height_name_code_title
            if not obj.heart_rate_name_title:
                obj.heart_rate_name_title = obj.heart_rate_name_code_title
            if not obj.oxygen_saturation_name_title:
                obj.oxygen_saturation_name_title = obj.oxygen_saturation_name_code_title
            if not obj.bp_site_title:
                obj.bp_site_title = obj.bp_site_code_title
            if not obj.temperature_name_title:
                obj.temperature_name_title = obj.temperature_name_code_title
            if not obj.head_circ_name_title:
                obj.head_circ_name_title = obj.head_circ_name_code_title
            if not obj.bp_position_title:
                obj.bp_position_title = obj.bp_position_code_title
            if not obj.bp_diastolic_name_title:
                obj.bp_diastolic_name_title = obj.bp_diastolic_name_code_title
            if not obj.respiratory_rate_name_title:
                obj.respiratory_rate_name_title = obj.respiratory_rate_name_code_title
            if not obj.bmi_name_title:
                obj.bmi_name_title = obj.bmi_name_code_title
            obj.save()
        
        for obj in orm.Allergy.objects.all():
            if not obj.allergic_reaction_title:
                obj.allergic_reaction_title = obj.allergic_reaction_code_title
            if not obj.other_allergen_title:
                obj.other_allergen_title = obj.other_allergen_code_title
            if not obj.severity_title:
                obj.severity_title = obj.severity_code_title
            if not obj.drug_class_allergen_title:
                obj.drug_class_allergen_title = obj.drug_class_allergen_code_title
            if not obj.drug_allergen_title:
                obj.drug_allergen_title = obj.drug_allergen_code_title
            if not obj.category_title:
                obj.category_title = obj.category_code_title
            obj.save()
            
        for obj in orm.Procedure.objects.all():
            if not obj.status_title:
                obj.status_title = obj.status_code_title
            if not obj.name_title:
                obj.name_title = obj.name_code_title
            obj.save()
            
        for obj in orm.AllergyExclusion.objects.all():
            if not obj.name_title:
                obj.name_title = obj.name_code_title
            obj.save()
            
        for obj in orm.Medication.objects.all():
            if not obj.provenance_title:
                obj.provenance_title = obj.provenance_code_title
            if not obj.name_title:
                obj.name_title = obj.name_code_title
            obj.save()
            
        for obj in orm.SocialHistory.objects.all():
            if not obj.smoking_status_title:
                obj.smoking_status_title = obj.smoking_status_code_title
            obj.save()
            
        for obj in orm.LabResult.objects.all():
            if not obj.status_title:
                obj.status_title = obj.status_code_title
            if not obj.name_title:
                obj.name_title = obj.name_code_title
            if not obj.abnormal_interpretation_title:
                obj.abnormal_interpretation_title = obj.abnormal_interpretation_code_title
            obj.save()
    ...
    models = {
        ...
        'indivo.allergy': {
            ...
            'allergic_reaction_title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'db_column': "'allergic_reaction_title'", 'blank': 'True'}),
            ...
            'category_title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'db_column': "'category_title'", 'blank': 'True'}),
            ...
            'drug_allergen_title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'db_column': "'drug_allergen_title'", 'blank': 'True'}),
            ...
            'drug_class_allergen_title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'db_column': "'drug_class_allergen_title'", 'blank': 'True'}),
            ...
            'other_allergen_title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'db_column': "'other_allergen_title'", 'blank': 'True'}),
            ...
            'severity_title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'db_column': "'severity_title'", 'blank': 'True'})
        },
        'indivo.allergyexclusion': {
            ...
            'name_title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'db_column': "'name_title'", 'blank': 'True'})
        },
        'indivo.audit': {
        ...
        'indivo.encounter': {
            ...
            'type_title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'db_column': "'type_title'", 'blank': 'True'})
        },
        'indivo.equipment': {
        ...
        'indivo.immunization': {
            ...
            'administration_status_title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'db_column': "'administration_status_title'", 'blank': 'True'}),
            'date': ('django.db.models.fields.DateTimeField', [], {'null': 'True'}),
            'fact_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['indivo.Fact']", 'unique': 'True', 'primary_key': 'True'}),
            ...
            'product_class_2_title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'db_column': "'product_class_2_title'", 'blank': 'True'}),
            ...
            'product_class_title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'db_column': "'product_class_title'", 'blank': 'True'}),
            ...
            'product_name_title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'db_column': "'product_name_title'", 'blank': 'True'}),
            ...
            'refusal_reason_title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'db_column': "'refusal_reason_title'", 'blank': 'True'})
        },
        'indivo.labresult': {
            ...
            'abnormal_interpretation_title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'db_column': "'abnormal_interpretation_title'", 'blank': 'True'}),
            ...
            'status_title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'db_column': "'status_title'", 'blank': 'True'})
        },
        'indivo.machineapp': {
        ...
        'indivo.medication': {
            ...
            'provenance_title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'db_column': "'provenance_title'", 'blank': 'True'}),
        ...
        'indivo.socialhistory': {
            ...
            'smoking_status_provenance_translation_fidelity_identifier': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'db_column': "'smoking_status_prov_tf_id'", 'blank': 'True'}),
            'smoking_status_provenance_translation_fidelity_system': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'db_column': "'smoking_status_prov_tf_sys'", 'blank': 'True'}),
            'smoking_status_provenance_translation_fidelity_title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'null': 'True', 'db_column': "'smoking_status_prov_tf_title'", 'blank': 'True'}),
            'smoking_status_title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'db_column': "'smoking_status_title'", 'blank': 'True'})
        },
        'indivo.statusname': {
        ...
        'indivo.vitalsigns': {
            ...
            'bmi_name_title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'db_column': "'bmi_name_title'", 'blank': 'True'}),
            ...
            'bp_diastolic_name_title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'db_column': "'bp_diastolic_name_title'", 'blank': 'True'}),
            ...
            'bp_method_title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'db_column': "'bp_method_title'", 'blank': 'True'}),
            ...
            'bp_position_title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'db_column': "'bp_position_title'", 'blank': 'True'}),
            ...
            'bp_site_title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'db_column': "'bp_site_title'", 'blank': 'True'}),
            ...
            'bp_systolic_name_title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'db_column': "'bp_systolic_name_title'", 'blank': 'True'}),
            ...
            'head_circ_name_title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'db_column': "'head_circ_name_title'", 'blank': 'True'}),
            ...
            'heart_rate_name_title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'db_column': "'heart_rate_name_title'", 'blank': 'True'}),
            ...
            'height_name_title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'db_column': "'height_name_title'", 'blank': 'True'}),
            ...
            'oxygen_saturation_name_title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'db_column': "'oxygen_saturation_name_title'", 'blank': 'True'}),
            ...
            'respiratory_rate_name_title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'db_column': "'respiratory_rate_name_title'", 'blank': 'True'}),
            ...
            'temperature_name_title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'db_column': "'temperature_name_title'", 'blank': 'True'}),
            ...
            'weight_name_title': ('django.db.models.fields.CharField', [], {'max_length': '255', 'db_column': "'weight_name_title'", 'blank': 'True'}),
