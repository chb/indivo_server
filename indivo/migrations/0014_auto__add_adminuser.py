...
class Migration(SchemaMigration):
    ...
    models = {
        ...
        'indivo.adminuser': {
            'Meta': {'object_name': 'AdminUser', '_ormbases': ['indivo.Principal']},
            'principal_ptr': ('django.db.models.fields.related.OneToOneField', [], {'to': "orm['indivo.Principal']", 'unique': 'True', 'primary_key': 'True'})
        },
        'indivo.allergy': {
