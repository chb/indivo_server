...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'LabPanel'
        db.create_table('indivo_labpanel', (
            ('fact_ptr', self.gf('django.db.models.fields.related.OneToOneField')(to=orm['indivo.Fact'], unique=True, primary_key=True)),
            ('name_provenance_source_code', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, db_column='name_prov_sc', blank=True)),
            ('name_provenance_translation_fidelity_identifier', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, db_column='name_prov_tf_id', blank=True)),
            ('name_provenance_translation_fidelity_system', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, db_column='name_prov_tf_sys', blank=True)),
            ('name_provenance_translation_fidelity_title', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, db_column='name_prov_tf_title', blank=True)),
            ('name_provenance_title', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, db_column='name_prov_title', blank=True)),
            ('name_code_identifier', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, db_column='name_code_id', blank=True)),
            ('name_code_system', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, db_column='name_code_sys', blank=True)),
            ('name_code_title', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, db_column='name_code_title', blank=True)),
            ('name_title', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, db_column='name_title', blank=True)),
        ))
        db.send_create_signal('indivo', ['LabPanel'])

        # Adding field 'LabResult.lab_panel'
        db.add_column('indivo_labresult', 'lab_panel', self.gf('django.db.models.fields.related.ForeignKey')(blank=True, related_name='lab_results', null=True, to=orm['indivo.LabPanel']), keep_default=False)


    def backwards(self, orm):
        
        # Deleting model 'LabPanel'
        db.delete_table('indivo_labpanel')

        # Deleting field 'LabResult.lab_panel'
        db.delete_column('indivo_labresult', 'lab_panel_id')
