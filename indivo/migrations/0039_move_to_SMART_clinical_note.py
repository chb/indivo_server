...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding model 'ClinicalNote'
        db.create_table('indivo_clinicalnote', (
            ...
            ('provider_bday', self.gf('django.db.models.fields.DateField')(null=True, db_column='provider_bday', blank=True)),
            ('provider_dea_number', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, db_column='provider_dea_number', blank=True)),
            ('provider_ethnicity', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, db_column='provider_ethnicity', blank=True)),
            ('provider_npi_number', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, db_column='provider_npi_number', blank=True)),
            ('provider_adr_postalcode', self.gf('django.db.models.fields.CharField')(max_length=12, null=True, db_column='provider_adr_postalcode', blank=True)),
            ('provider_adr_country', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, db_column='provider_adr_country', blank=True)),
            ('provider_adr_region', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, db_column='provider_adr_region', blank=True)),
            ('provider_adr_street', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, db_column='provider_adr_street', blank=True)),
            ('provider_adr_city', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, db_column='provider_adr_city', blank=True)),
            ('provider_name_middle', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, db_column='provider_name_middle', blank=True)),
            ('provider_name_given', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, db_column='provider_name_given', blank=True)),
            ('provider_name_prefix', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, db_column='provider_name_prefix', blank=True)),
            ('provider_name_family', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, db_column='provider_name_family', blank=True)),
            ('provider_name_suffix', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, db_column='provider_name_suffix', blank=True)),
            ('provider_preferred_language', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, db_column='provider_preferred_language', blank=True)),
            ('provider_tel_2_type', self.gf('django.db.models.fields.CharField')(max_length=1, null=True, db_column='provider_tel_2_type', blank=True)),
            ('provider_tel_2_number', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, db_column='provider_tel_2_number', blank=True)),
            ('provider_tel_2_preferred_p', self.gf('django.db.models.fields.BooleanField')(default=False, db_column='provider_tel_2_preferred_p')),
            ('provider_tel_1_type', self.gf('django.db.models.fields.CharField')(max_length=1, null=True, db_column='provider_tel_1_type', blank=True)),
            ('provider_tel_1_number', self.gf('django.db.models.fields.CharField')(max_length=20, null=True, db_column='provider_tel_1_number', blank=True)),
            ('provider_tel_1_preferred_p', self.gf('django.db.models.fields.BooleanField')(default=False, db_column='provider_tel_1_preferred_p')),
            ('provider_race', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, db_column='provider_race', blank=True)),
            ('provider_gender', self.gf('django.db.models.fields.CharField')(max_length=255, null=True, db_column='provider_gender', blank=True)),
            ('provider_email', self.gf('django.db.models.fields.EmailField')(max_length=255, null=True, db_column='provider_email', blank=True)),
        ))
        db.send_create_signal('indivo', ['ClinicalNote'])
    ...
    def backwards(self, orm):
        ...
        # Deleting model 'ClinicalNote'
        db.delete_table('indivo_clinicalnote')
