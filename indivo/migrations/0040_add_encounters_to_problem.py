...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding M2M table for field encounters on 'Problem'
        db.create_table('indivo_problem_encounters', (
            ('id', models.AutoField(verbose_name='ID', primary_key=True, auto_created=True)),
            ('problem', models.ForeignKey(orm['indivo.problem'], null=False)),
            ('encounter', models.ForeignKey(orm['indivo.encounter'], null=False))
        ))
        db.create_unique('indivo_problem_encounters', ['problem_id', 'encounter_id'])


    def backwards(self, orm):
        
        # Removing M2M table for field encounters on 'Problem'
        db.delete_table('indivo_problem_encounters')
